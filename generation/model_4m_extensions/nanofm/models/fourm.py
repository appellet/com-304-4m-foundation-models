...
class FourM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.frame_pos_emb = nn.Embedding(17, dim)  # Assuming max 17 frames for 8 it will be 8
    ...
    def generate_one_modality_roar(
        ...
        for step, k in enumerate(schedule):
            ...
            enc_input_positions = torch.cat([enc_input_positions, dec_input_positions.to(device)], dim=1) # .to( device) 
